...
# PreNorm layer with Layer Normalization
...
# XMT Model definition
class XMT(nn.Module):
    def __init__(self, image_size=224, patch_size=7, num_classes=2, channels=512, dim=1024, depth=6, heads=8, mlp_dim=2048):
